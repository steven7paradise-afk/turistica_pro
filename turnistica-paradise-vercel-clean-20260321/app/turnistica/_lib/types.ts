...
export type ScheduleAssistantAction =
  | {
      action: "assign_shift";
      employee: string;
      store: string;
...
export type ScheduleAssistantMemoryUpdate = {
  type: "preference";
  employee: string;
  content: string;
};
...
export type ScheduleAssistantResponse = {
  reply: string;
  actions: ScheduleAssistantAction[];
  warnings: string[];
  memory_updates: ScheduleAssistantMemoryUpdate[];
};
